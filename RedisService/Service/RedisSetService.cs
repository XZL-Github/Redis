...
namespace RedisService.Service
{
    ...
    {
        public RedisSetService(IRedisClient redisClient) : base(redisClient)
        {
        }
        #region 添加
        /// <summary>
        ...
        {
            base._IRedisClient.AddItemToSet(key, value);
        }
        /// <summary>
        /// key集合中添加list集合
        /// </summary>
        ...
        {
            base._IRedisClient.AddRangeToSet(key, list);
        }
        #endregion
        ...
        {
            return base._IRedisClient.GetRandomItemFromSet(key);
        }
        /// <summary>
        /// 获取所有key集合的数量
        /// </summary>
        ...
        {
            return base._IRedisClient.GetSetCount(key);
        }
        /// <summary>
        /// 获取所有key集合的值
        /// </summary>
        ...
        {
            return base._IRedisClient.GetAllItemsFromSet(key);
        }
        ...
        {
            return base._IRedisClient.PopItemFromSet(key);
        }
        /// <summary>
        /// 删除key集合中的value
        /// </summary>
        ...
        {
            base._IRedisClient.RemoveItemFromSet(key, value);
        }
        #endregion
        ...
        {
            base._IRedisClient.MoveBetweenSets(formkey, tokey, value);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetUnionFromSets(keys);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetIntersectFromSets(keys);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetDifferencesFromSet(fromkey, keys);
        }
        /// <summary>
        ...
        {
            base._IRedisClient.StoreUnionFromSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            base._IRedisClient.StoreDifferencesFromSet(newkey, fromkey, keys);
        } 
        #endregion
    }
}
