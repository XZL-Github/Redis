...
namespace RedisService.Service
{
    ...
    {
        public RedisZSetService(IRedisClient redisClient) : base(redisClient)
        {
        }
        #region 添加
        /// <summary>
        ...
        {
            return base._IRedisClient.AddItemToSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.AddItemToSortedSet(key, value, score);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.AddRangeToSortedSet(key, values, score);
        }
        /// <summary>
        /// 为key添加values集合，values集合中每个value的分数设置为score
        /// </summary>
        ...
        {
            return base._IRedisClient.GetAllItemsFromSortedSet(key);
        }
        /// <summary>
        /// 获取key的所有集合，倒叙输出
        /// </summary>
        ...
        {
            return base._IRedisClient.GetAllItemsFromSortedSetDesc(key);
        }
        /// <summary>
        /// 获取集合，带分数
        /// </summary>
        ...
        {
            return base._IRedisClient.GetAllWithScoresFromSortedSet(key);
        }
        /// <summary>
        /// 获取key为value的下标值
        /// </summary>
        ...
        {
            return base._IRedisClient.GetItemIndexInSortedSet(key, value);
        }
        /// <summary>
        /// 倒叙排列获取key为value的下标值
        /// </summary>
        ...
        {
            return base._IRedisClient.GetItemIndexInSortedSetDesc(key, value);
        }
        /// <summary>
        /// 获取key为value的分数
        /// </summary>
        ...
        {
            return base._IRedisClient.GetItemScoreInSortedSet(key, value);
        }
        /// <summary>
        /// 获取key所有集合的数据总数
        /// </summary>
        ...
        {
            return base._IRedisClient.GetSortedSetCount(key);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetSortedSetCount(key, fromScore, toScore);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeWithScoresFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeWithScoresFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeFromSortedSetDesc(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeWithScoresFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetRangeWithScoresFromSortedSetDesc(key, fromRank, toRank);
        }
        #endregion
        ...
        {
            return base._IRedisClient.RemoveItemFromSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.RemoveRangeFromSortedSet(key, minRank, maxRank);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.RemoveRangeFromSortedSetByScore(key, fromscore, toscore);
        }
        /// <summary>
        /// 删除key集合中分数最大的数据
        /// </summary>
        ...
        {
            return base._IRedisClient.PopItemWithHighestScoreFromSortedSet(key);
        }
        /// <summary>
        /// 删除key集合中分数最小的数据
        /// </summary>
        ...
        {
            return base._IRedisClient.PopItemWithLowestScoreFromSortedSet(key);
        }
        #endregion
        ...
        {
            return base._IRedisClient.SortedSetContainsItem(key, value);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.IncrementItemInSortedSet(key, value, scoreBy);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.StoreIntersectFromSortedSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.StoreUnionFromSortedSets(newkey, keys);
        }
        #endregion
    }
}
