...
namespace RedisService.Service
{
    ...
    {
        public RedisHashService(IRedisClient redisClient) : base(redisClient)
        {
        }
        #region 添加
        /// <summary>
        ...
        {
            return base._IRedisClient.SetEntryInHash(hashId, key, value);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.SetEntryInHashIfNotExists(hashId, key, value);
        }
        /// <summary>
        /// 存储对象T t到hash集合中
        /// 需要包含Id,然后用Id获取
        ...
        {
            base._IRedisClient.StoreAsHash<T>(t);
        }
        #endregion
        ...
        {
            return base._IRedisClient.GetFromHash<T>(id);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetAllEntriesFromHash(hashId);
        }
        /// <summary>
        /// 获取hashId数据集中的数据总数
        /// </summary>
        ...
        {
            return base._IRedisClient.GetHashCount(hashId);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetHashKeys(hashId);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetHashValues(hashId);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetValueFromHash(hashId, key);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.GetValuesFromHash(hashId, keys);
        }
        #endregion
        ...
        {
            return base._IRedisClient.RemoveEntryFromHash(hashId, key);
        }
        #endregion
        ...
        {
            return base._IRedisClient.HashContainsEntry(hashId, key);
        }
        /// <summary>
        ...
        {
            return base._IRedisClient.IncrementValueInHash(hashId, key, countBy);
        } 
        #endregion
    }
}
