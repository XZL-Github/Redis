...
namespace Redis.Helper.Service
{
    ...
    public class RedisZSetService: RedisBase
    {
        ...
        {
            return base.iRedisClient.AddItemToSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.AddItemToSortedSet(key, value, score);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.AddRangeToSortedSet(key, values, score);
        }
        /// <summary>
        /// 为key添加values集合，values集合中每个value的分数设置为score
        /// </summary>
        ...
        {
            return base.iRedisClient.GetAllItemsFromSortedSet(key);
        }
        /// <summary>
        /// 获取key的所有集合，倒叙输出
        /// </summary>
        ...
        {
            return base.iRedisClient.GetAllItemsFromSortedSetDesc(key);
        }
        /// <summary>
        /// 获取集合，带分数
        /// </summary>
        ...
        {
            return base.iRedisClient.GetAllWithScoresFromSortedSet(key);
        }
        /// <summary>
        /// 获取key为value的下标值
        /// </summary>
        ...
        {
            return base.iRedisClient.GetItemIndexInSortedSet(key, value);
        }
        /// <summary>
        /// 倒叙排列获取key为value的下标值
        /// </summary>
        ...
        {
            return base.iRedisClient.GetItemIndexInSortedSetDesc(key, value);
        }
        /// <summary>
        /// 获取key为value的分数
        /// </summary>
        ...
        {
            return base.iRedisClient.GetItemScoreInSortedSet(key, value);
        }
        /// <summary>
        /// 获取key所有集合的数据总数
        /// </summary>
        ...
        {
            return base.iRedisClient.GetSortedSetCount(key);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetSortedSetCount(key, fromScore, toScore);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeWithScoresFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeWithScoresFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeFromSortedSetDesc(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeWithScoresFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.GetRangeWithScoresFromSortedSetDesc(key, fromRank, toRank);
        }
        #endregion
        ...
        {
            return base.iRedisClient.RemoveItemFromSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.RemoveRangeFromSortedSet(key, minRank, maxRank);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.RemoveRangeFromSortedSetByScore(key, fromscore, toscore);
        }
        /// <summary>
        /// 删除key集合中分数最大的数据
        /// </summary>
        ...
        {
            return base.iRedisClient.PopItemWithHighestScoreFromSortedSet(key);
        }
        /// <summary>
        /// 删除key集合中分数最小的数据
        /// </summary>
        ...
        {
            return base.iRedisClient.PopItemWithLowestScoreFromSortedSet(key);
        }
        #endregion
        ...
        {
            return base.iRedisClient.SortedSetContainsItem(key, value);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.IncrementItemInSortedSet(key, value, scoreBy);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.StoreIntersectFromSortedSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            return base.iRedisClient.StoreUnionFromSortedSets(newkey, keys);
        }
        #endregion
    }
}
